...
real(8) :: dtout=30d0,tdur=900d0                  !output rate and total runtime
real(8) :: dt1,dt2
real(8) :: toutnext
...
!    B3=0d0
  ...
  subroutine boundaries(t,x1,x2,rhom,rhov1,rhov2,rhov3,rhoeps,B1,B2,B3)
    ...
    real(8) :: vsw
    real(8) :: Ti=1d4                             !temperature of plasma injected from the boundary
    ...
    vsw=0d0*sqrt(gammap*kb*Ti/amu)                         !background solar wind
