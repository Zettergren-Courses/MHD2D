...
real(8), parameter :: stride1=2.5d6,stride2=2.5d6
...
real(8) :: dtout=90d0,tdur=7200d0                  !output rate and total runtime
real(8) :: dt1,dt2
real(8) :: toutnext

real(8) :: tstart,tfin                           !for assessing performance of code blocks

real(8) :: objrad=5d0*Rearth
real(8) :: r
...
!           B1(ix1,ix2)=0d0
  ...
  subroutine boundaries(t,x1,x2,rhom,rhov1,rhov2,rhov3,rhoeps,B1,B2,B3)
    ...
    vsw=5d0*sqrt(gammap*kb*Ti/amu)                         !background solar wind
