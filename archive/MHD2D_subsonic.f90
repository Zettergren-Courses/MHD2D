...
real(8) :: dtout=30d0,tdur=7200d0                  !output rate and total runtime
real(8) :: dt1,dt2
real(8) :: toutnext
...
contains
  ...
  subroutine initialization(t,x1,x2,rhom,rhov1,rhov2,rhov3,rhoeps,B1,B2,B3)
    ...
    vsw=1d0/2d0*sqrt(kb*Ti/amu/(gammap-1d0))
  ...
  subroutine boundaries(t,x1,x2,rhom,rhov1,rhov2,rhov3,rhoeps,B1,B2,B3)
    ...
    vsw=1d0/2d0*sqrt(kb*Ti/amu/(gammap-1d0))                         !background solar wind
